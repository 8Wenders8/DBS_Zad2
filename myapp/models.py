...
class MatchesPlayersDetails(models.Model):
    match = models.ForeignKey(Matches, models.DO_NOTHING, blank=True, null=True, related_name='match')
    player = models.ForeignKey('Players', models.DO_NOTHING, blank=True, null=True, related_name='player')
    hero = models.ForeignKey(Heroes, models.DO_NOTHING, blank=True, null=True, related_name='hero')
...
class TeamfightsPlayers(models.Model):
    teamfight = models.ForeignKey(Teamfights, models.DO_NOTHING, blank=True, null=True, related_name='teamfight')
    match_player_detail = models.ForeignKey(MatchesPlayersDetails, models.DO_NOTHING, blank=True, null=True, related_name='match_player_detail')
